...
set_property -dict [list CONFIG.instruction1 {A*B} CONFIG.pipeline_options {Expert} CONFIG.areg_3 {false} CONFIG.breg_3 {false} CONFIG.mreg_5 {false} CONFIG.a_width {25} CONFIG.has_pcout {true} CONFIG.has_a_ce {true} CONFIG.has_b_ce {true} CONFIG.has_p_ce {false} CONFIG.areg_4 {true} CONFIG.breg_4 {true} CONFIG.creg_3 {false} CONFIG.creg_4 {false} CONFIG.creg_5 {false} CONFIG.preg_6 {true} CONFIG.has_p_ce {true} CONFIG.d_width {18} CONFIG.a_binarywidth {0} CONFIG.b_width {18} CONFIG.b_binarywidth {0} CONFIG.concat_width {48} CONFIG.concat_binarywidth {0} CONFIG.c_binarywidth {0} CONFIG.pcin_binarywidth {0} CONFIG.p_full_width {43} CONFIG.p_width {43} CONFIG.p_binarywidth {0}] [get_ips $ipname]
# 
